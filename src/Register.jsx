  ...
  return (
    <div>
      ...
      <div className="bg-slate-800 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative">
        <h3 className="text-4xl text-white text-center mb-6">Create an Account</h3>
        <form onSubmit={handleSubmit}>
          ...
          <div className="relative my-4">
            <input
              type="password"
              id="password"
              className="block w-72 py-2.3 px-0 text-small text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-yellow-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer"
              placeholder=""
              onChange={handleChange}
            />
            <label
              htmlFor="password"
              className="absolute text-sm text-white duration-300  left-0 -translate-y-6 scale-75 top-3 z-10 origin-[0] peer-focus-left-0 peer-focus:text-yellow-600 peer-focus:dark:text-yellow-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >
              Your Password
            </label>
          </div>
